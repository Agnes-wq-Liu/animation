...
public class RigidBody {
    ...
    public double lambdaNorm;
    public double lambdaTan;
    public double lN;
    public double lF;
    ...
    HashMap<Block, Integer> BlockHash =new HashMap<>();
    /** Boundary blocks */
    ...
    public void applyContactForceW( Point2d contactPointW, Vector2d contactForceW ) {
        ...
        torque = (contactPointW.x-x.x)*contactForceW.y - (contactPointW.y-x.y)*contactForceW.x;
    }
